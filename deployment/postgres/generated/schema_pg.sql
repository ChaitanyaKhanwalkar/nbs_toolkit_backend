...
CREATE TABLE "app_district_profile_cache" (
    ...
    "representative_stations" TEXT,
    "lat_mean" DOUBLE PRECISION,
    "lon_mean" DOUBLE PRECISION,
    "rainfall_mm_yr_mean" DOUBLE PRECISION,
    "tmin_c_mean" DOUBLE PRECISION,
    "tmax_c_mean" DOUBLE PRECISION,
    "soil_types" TEXT,
    "infiltration_classes" TEXT,
    "slope_mean" DOUBLE PRECISION,
    "stream_order_strahler_max" BIGINT,
    "nat_discharge_cms_mean" DOUBLE PRECISION,
    "site_agri_pct" DOUBLE PRECISION,
    "site_builtup_pct" DOUBLE PRECISION,
    "site_trees_pct" DOUBLE PRECISION,
    "lulc_2024_agriculture_pct" DOUBLE PRECISION,
    "lulc_2024_builtup_pct" DOUBLE PRECISION,
    "lulc_2024_forest_pct" DOUBLE PRECISION,
    "lulc_2024_water_pct" DOUBLE PRECISION,
    "domestic_sewage_mld" DOUBLE PRECISION,
    "industrial_wastewater_mld" DOUBLE PRECISION,
    "stp_capacity_operational_mld" DOUBLE PRECISION,
    "stp_capacity_under_construction_mld" DOUBLE PRECISION,
    "stp_count_operational" DOUBLE PRECISION,
    "stp_count_under_construction" DOUBLE PRECISION,
    "dominant_pressure_label" TEXT,
    "recommended_pathway_label" TEXT,
...
CREATE TABLE "narmada_hydrology_stations" (
    ...
    "lat" DOUBLE PRECISION,
    "lon" DOUBLE PRECISION,
    "zero_gauge_m" DOUBLE PRECISION,
    "max_level_m" DOUBLE PRECISION,
    "min_level_m" DOUBLE PRECISION,
    "avg_level_m" DOUBLE PRECISION,
    "max_discharge_cumec" DOUBLE PRECISION,
    "min_discharge_cumec" DOUBLE PRECISION,
    "avg_discharge_cumec" DOUBLE PRECISION,
    "sub_basin" TEXT,
    "geometry_wkt" TEXT,
    "note" TEXT,
    "provenance_status_id" BIGINT NOT NULL,
...
CREATE TABLE "narmada_infrastructure_assets" (
    ...
    "capacity_unit" TEXT,
    "generated_value" DOUBLE PRECISION,
    "generated_unit" TEXT,
    "technology" TEXT,
    "reuse_value" DOUBLE PRECISION,
    "reuse_unit" TEXT,
    "network_length_km" DOUBLE PRECISION,
    "connections" BIGINT,
    "lat" DOUBLE PRECISION,
    "lon" DOUBLE PRECISION,
    "geometry_wkt" TEXT,
...
CREATE TABLE "narmada_nutrient_sediment_metrics" (
    ...
    "unit" TEXT,
    "contribution_point" TEXT,
    "contribution_nonpoint" TEXT,
    "key_quantification" TEXT,
    "primary_driver" TEXT,
    "literature_authors" TEXT,
    "note" TEXT,
    "provenance_status_id" BIGINT NOT NULL,
    "created_at" TEXT,
    PRIMARY KEY ("id")
...
CREATE TABLE "nbs_applicability_rules" (
    ...
    "nbs_id" BIGINT,
    "nbs_solution" TEXT,
    "nbs_family_id" BIGINT,
    "nbs_family" TEXT,
    "train_id" BIGINT,
    "train_name" TEXT,
    "factor_name" TEXT NOT NULL,
    "factor_source_field" TEXT,
    "intervention_position" TEXT,
    "operator" TEXT,
    "value_min" DOUBLE PRECISION,
    "value_max" DOUBLE PRECISION,
    "category_value" TEXT,
    ...
    "score_modifier" DOUBLE PRECISION,
...
CREATE TABLE "standards_gapfix_review_log" (
    ...
    "threshold_basis" TEXT,
    "target_type" TEXT,
    "source_exact_value" TEXT,
    "existing_db_status" TEXT,
    "mapping_note" TEXT,
    "sql_action" TEXT,
    "created_at" TEXT,
    PRIMARY KEY ("id")
...
CREATE TABLE "train_performance" (
    ...
    "train_id" BIGINT,
    "parameter" TEXT,
    "influent_low" DOUBLE PRECISION,
    "influent_high" DOUBLE PRECISION,
    "cum_removal_low" DOUBLE PRECISION,
    "cum_removal_high" DOUBLE PRECISION,
    "effluent_low" DOUBLE PRECISION,
    "effluent_high" DOUBLE PRECISION,
    "steps_with_data" BIGINT,
    "note" TEXT,
    PRIMARY KEY ("id")
);
...
SELECT
        ...
        ROUND((lat_mean)::numeric, 5) AS lat,
        ROUND((lon_mean)::numeric, 5) AS lon,
        ROUND((rainfall_mm_yr_mean)::numeric, 1) AS rainfall_mm_yr,
        ROUND((tmin_c_mean)::numeric, 1) AS tmin_c,
        ROUND((tmax_c_mean)::numeric, 1) AS tmax_c,
        soil_types,
        infiltration_classes,
        ROUND((slope_mean)::numeric, 2) AS slope_mean,
        stream_order_strahler_max,
        ROUND((nat_discharge_cms_mean)::numeric, 3) AS nat_discharge_cms,
        ROUND((site_agri_pct)::numeric, 1) AS site_agri_pct,
        ROUND((site_builtup_pct)::numeric, 1) AS site_builtup_pct,
        ROUND((site_trees_pct)::numeric, 1) AS site_trees_pct,
        ROUND((lulc_2024_agriculture_pct)::numeric, 1) AS lulc_2024_agriculture_pct,
        ROUND((lulc_2024_builtup_pct)::numeric, 1) AS lulc_2024_builtup_pct,
        ROUND((lulc_2024_forest_pct)::numeric, 1) AS lulc_2024_forest_pct,
        ROUND((lulc_2024_water_pct)::numeric, 1) AS lulc_2024_water_pct,
        ROUND((domestic_sewage_mld)::numeric, 3) AS domestic_sewage_mld,
        ROUND((industrial_wastewater_mld)::numeric, 3) AS industrial_wastewater_mld,
        ROUND((stp_capacity_operational_mld)::numeric, 3) AS stp_capacity_operational_mld,
        ROUND((stp_capacity_under_construction_mld)::numeric, 3) AS stp_capacity_under_construction_mld,
...
SELECT
    ...
    GROUP BY p.id, p.plant_species, p.native_status, p.invasive, p.plant_type, p.locational_availability, p.climate_preference, p.soil_type, p.water_needs, p.ecological_role, p.pollution_tolerance, p.metals_pollutants, p.optimal_water_type, p.evidence_note;
...
WITH ordered_steps AS (
        ...
        SELECT
            ...
            STRING_AGG((CASE
                    ...
                    ELSE parameter || ': ' || ROUND((cum_removal_low)::numeric, 1) || '-' || ROUND((cum_removal_high)::numeric, 1) || '%'
