...
(3, 'irrigation', 'C1', 'treatment_fit', 0.228136, 'benefit', 'FINAL_V1_AHP_FUZZY_ENSEMBLE', 'Final working weights used in this report; irrigation crisp + fuzzy AHP ensemble after O&M re-blend, 2026-06-30. Not labelled expert-validated unless supervisor approval is documented.', 104, 2, datetime('now')),
(3, 'irrigation', 'C2', 'standard_fit', 0.228136, 'benefit', 'FINAL_V1_AHP_FUZZY_ENSEMBLE', 'Final working weights used in this report; irrigation crisp + fuzzy AHP ensemble after O&M re-blend, 2026-06-30. Not labelled expert-validated unless supervisor approval is documented.', 104, 2, datetime('now')),
(3, 'irrigation', 'C3', 'site_fit', 0.095330, 'benefit', 'FINAL_V1_AHP_FUZZY_ENSEMBLE', 'Final working weights used in this report; irrigation crisp + fuzzy AHP ensemble after O&M re-blend, 2026-06-30. Not labelled expert-validated unless supervisor approval is documented.', 104, 2, datetime('now')),
(3, 'irrigation', 'C4', 'source_fit', 0.117709, 'benefit', 'FINAL_V1_AHP_FUZZY_ENSEMBLE', 'Final working weights used in this report; irrigation crisp + fuzzy AHP ensemble after O&M re-blend, 2026-06-30. Not labelled expert-validated unless supervisor approval is documented.', 104, 2, datetime('now')),
(3, 'irrigation', 'C6', 'hydrologic_fit', 0.057781, 'benefit', 'FINAL_V1_AHP_FUZZY_ENSEMBLE', 'Final working weights used in this report; irrigation crisp + fuzzy AHP ensemble after O&M re-blend, 2026-06-30. Not labelled expert-validated unless supervisor approval is documented.', 104, 2, datetime('now')),
(3, 'irrigation', 'C7', 'footprint_land', 0.117709, 'cost', 'FINAL_V1_AHP_FUZZY_ENSEMBLE', 'Final working weights used in this report; irrigation crisp + fuzzy AHP ensemble after O&M re-blend, 2026-06-30. Not labelled expert-validated unless supervisor approval is documented.', 104, 2, datetime('now')),
(3, 'irrigation', 'C8', 'om_energy_difficulty', 0.155200, 'cost', 'FINAL_V1_AHP_FUZZY_ENSEMBLE', 'Final working weights used in this report; irrigation crisp + fuzzy AHP ensemble after O&M re-blend, 2026-06-30. Not labelled expert-validated unless supervisor approval is documented.', 104, 2, datetime('now'));
