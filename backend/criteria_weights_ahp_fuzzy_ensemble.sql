...
(3, 'irrigation', 'C1', 'treatment_fit', 0.240262, 'benefit', 'FINAL_V1_AHP_FUZZY_ENSEMBLE', 'Final v1 AHP-Fuzzy AHP ensemble weights for demo ranking. C5 health-risk integration remains reserved for future expert data.', 104, 2, datetime('now')),
(3, 'irrigation', 'C2', 'standard_fit', 0.240262, 'benefit', 'FINAL_V1_AHP_FUZZY_ENSEMBLE', 'Final v1 AHP-Fuzzy AHP ensemble weights for demo ranking. C5 health-risk integration remains reserved for future expert data.', 104, 2, datetime('now')),
(3, 'irrigation', 'C3', 'site_fit', 0.094255, 'benefit', 'FINAL_V1_AHP_FUZZY_ENSEMBLE', 'Final v1 AHP-Fuzzy AHP ensemble weights for demo ranking. C5 health-risk integration remains reserved for future expert data.', 104, 2, datetime('now')),
(3, 'irrigation', 'C4', 'source_fit', 0.115706, 'benefit', 'FINAL_V1_AHP_FUZZY_ENSEMBLE', 'Final v1 AHP-Fuzzy AHP ensemble weights for demo ranking. C5 health-risk integration remains reserved for future expert data.', 104, 2, datetime('now')),
(3, 'irrigation', 'C6', 'hydrologic_fit', 0.057253, 'benefit', 'FINAL_V1_AHP_FUZZY_ENSEMBLE', 'Final v1 AHP-Fuzzy AHP ensemble weights for demo ranking. C5 health-risk integration remains reserved for future expert data.', 104, 2, datetime('now')),
(3, 'irrigation', 'C7', 'footprint', 0.115706, 'cost', 'FINAL_V1_AHP_FUZZY_ENSEMBLE', 'Final v1 AHP-Fuzzy AHP ensemble weights for demo ranking. C5 health-risk integration remains reserved for future expert data.', 104, 2, datetime('now')),
(3, 'irrigation', 'C8', 'om', 0.136557, 'cost', 'FINAL_V1_AHP_FUZZY_ENSEMBLE', 'Final v1 AHP-Fuzzy AHP ensemble weights for demo ranking. C5 health-risk integration remains reserved for future expert data.', 104, 2, datetime('now'));
